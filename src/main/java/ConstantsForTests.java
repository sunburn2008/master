public class ConstantsForTests {
    ...
    public static final String userName_1 = "Иван";
    public static final String userSurname_1 = "Таранов";
    public static final String userAddress_1 = "ул. Пукшина, д. 5, кв. 15";
    public static final String userPhoneNumber_1 = "+74959379992";
    public static final String commentForTheCourier_1 = "Шире шаг!";
